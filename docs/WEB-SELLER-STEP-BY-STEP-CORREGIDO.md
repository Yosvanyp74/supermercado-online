...
### Archivo: `apps/web-admin/src/app/(auth)/login/page.tsx`

**ACCIÓN**: MODIFICAR (si existe) o CREAR (si no existe)

**UBICACIÓN EXACTA**: `apps/web-admin/src/app/(auth)/login/page.tsx`
...
### Archivo: `apps/web-admin/src/app/(vendedor)/vendedor/layout.tsx`

**ACCIÓN**: CREAR archivo nuevo

**UBICACIÓN EXACTA**: `apps/web-admin/src/app/(vendedor)/vendedor/layout.tsx`
...
### Archivo: `apps/web-admin/src/app/(vendedor)/vendedor/page.tsx`

**ACCIÓN**: CREAR archivo nuevo

**UBICACIÓN EXACTA**: `apps/web-admin/src/app/(vendedor)/vendedor/page.tsx`
...
### Archivo: `apps/web-admin/src/app/(vendedor)/vendedor/pedidos/page.tsx`

**ACCIÓN**: CREAR archivo nuevo

**UBICACIÓN EXACTA**: `apps/web-admin/src/app/(vendedor)/vendedor/pedidos/page.tsx`
...
async getOrders(
  ...
  // pass sellerId from JWT – this is the value that gets written into
  // orders.sellerId when an order is accepted.  The two IDs are not
  // interchangeable, so filtering by a different user property won't work.
...
1. `apps/web-admin/src/app/(auth)/login/page.tsx` - Agregar redirección por rol
2. `apps/web-admin/middleware.ts` - Agregar protección de rutas
3. `apps/backend/src/app.module.ts` - Agregar SellerModule

### Archivos CREADOS:
1. `apps/web-admin/src/app/(vendedor)/vendedor/layout.tsx`
2. `apps/web-admin/src/app/(vendedor)/vendedor/page.tsx`
3. `apps/web-admin/src/app/(vendedor)/vendedor/pedidos/page.tsx`
